...
(function (global) {
  ...
  /** 非危险品 · 低价 FBA（小号/大号标准，公开整理） */
  var LOW_PRICE_STANDARD = {
    small_standard: [
      { maxOz: 2, fee: 3.06, lowPrice: 2.47 },
      { maxOz: 4, fee: 3.15, lowPrice: 2.54 },
      { maxOz: 6, fee: 3.24, lowPrice: 2.63 },
      { maxOz: 8, fee: 3.33, lowPrice: 2.72 },
      { maxOz: 10, fee: 3.43, lowPrice: 2.81 },
      { maxOz: 12, fee: 3.53, lowPrice: 2.91 },
      { maxOz: 14, fee: 3.6, lowPrice: 2.98 },
      { maxOz: 16, fee: 3.65, lowPrice: 3.03 },
    ],
    large_standard: [
      { maxOz: 4, fee: 3.68, lowPrice: 3.21 },
      { maxOz: 8, fee: 3.9, lowPrice: 3.33 },
      { maxOz: 12, fee: 4.15, lowPrice: 3.53 },
      { maxOz: 16, fee: 4.55, lowPrice: 3.77 },
      { maxOz: 20, fee: 4.99, lowPrice: 4.09 },
      { maxOz: 24, fee: 5.37, lowPrice: 4.27 },
      { maxOz: 28, fee: 5.52, lowPrice: 4.46 },
      { maxOz: 32, fee: 5.77, lowPrice: 4.71 },
      { maxOz: 36, fee: 5.87, lowPrice: null },
      { maxOz: 40, fee: 6.05, lowPrice: null },
      { maxOz: 44, fee: 6.21, lowPrice: null },
      { maxOz: 48, fee: 6.62, lowPrice: null },
    ],
  };
  ...
  function getDgFbaUsd(resolvedTier, shipOz) {
    ...
    if (resolvedTier === "large_standard" && shipOz > 48) {
      ...
      return last.fee + Math.ceil(extra / 4) * 0.08;
    }
